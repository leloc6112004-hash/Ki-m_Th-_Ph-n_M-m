          ...
          <div className="bg-white rounded-xl md:rounded-2xl shadow-xl p-6 md:p-8 lg:p-12">
            ...
            <div className="text-center mb-6 md:mb-8">
              ...
              <p className="text-sm md:text-base lg:text-lg text-gray-600 px-4">
                ...
                , tính năng đặt lịch hẹn đang được phát triển
              </p>
            </div>

            {/* Coming Soon Message */}
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 md:p-6 text-center">
              <p className="text-green-800 text-base md:text-lg font-medium mb-2">
                🚀 Tính năng sắp ra mắt
              </p>
              <p className="text-green-700 text-sm md:text-base">
                Chúng tôi đang hoàn thiện tính năng đặt lịch hẹn để mang đến
