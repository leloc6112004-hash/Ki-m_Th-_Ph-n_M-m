        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl md:rounded-2xl shadow-xl p-6 md:p-8 lg:p-12">
            ...
            <div className="text-center mb-6 md:mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-purple-100 rounded-full mb-3 md:mb-4">
                <ClipboardList className="w-8 h-8 md:w-10 md:h-10 text-purple-600" />
              </div>
              ...
              <p className="text-sm md:text-base lg:text-lg text-gray-600 px-4">
                ...
                tính năng xem kết quả khám đang được phát triển
              </p>
            </div>

            {/* Coming Soon Message */}
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 md:p-6 text-center">
              <p className="text-purple-800 text-base md:text-lg font-medium mb-2">
                🚀 Tính năng sắp ra mắt
              </p>
              <p className="text-purple-700 text-sm md:text-base">
                Chúng tôi đang hoàn thiện tính năng xem kết quả khám để mang đến trải nghiệm tốt nhất cho bạn.
