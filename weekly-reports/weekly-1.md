...
|------------|------|-----------|----------------| 
| Lê Hữu Lộc | 2254052040| xác nhận đề tài | b793963 |
| Nguyễn Trí Lợi | 2254050034| - | - | 
| Nguyễn Lê Đăng Khoa | 2151010172| - | - | 
| Võ Nguyên Hùng | 2151010144| -| - | 
---
## 2. Tiến độ tổng thể 
| Hạng mục | Trạng thái | % | 
|----------|------------|---|
| Phân tích yêu cầu | In progress| 20% |
**Tổng tiến độ: 10%** 
--- ## 3. Kế hoạch tuần tới
| Thành viên | Công việc dự kiến |
|------------|-------------------| 
| Lê Hữu Lộc | Phân tích tài liệu tiếp | 
| Nguyễn Trí Lợi | Phân tích tài liệu tiếp | 
|Nguyễn Lê Đăng Khoa | test API backend |
 |  Võ Nguyên Hùng | - |
 --- ## 4. Khó khăn / Cần hỗ trợ
 - Nhóm gặp 1 số việc cá nhân giữ các thành viên
--- 
*Ngày nộp: 21/03/2026* 
